...
For an order of magnitude understanding, how much power would be consumed by a loop of copper wire generating a magnetic field to trap neutrons in a circular path with radius 0.1m? \\
